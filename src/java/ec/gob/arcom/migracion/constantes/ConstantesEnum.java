...
public enum ConstantesEnum {
    ...
    ESTCOMP_ARCHIVADO("PARCHIVADO","Archivado", 576L),
    ...
    RPT_RETENCIONES_ABONOS("RPTRETEABON","RETENCIONES Y ABONOS", 100014L),
    
    RPT_USUARIOS_SGM("RPTUSUARIOSSGM", "USUARIOS SGM", 100023L),
    RPT_SALDO_VACACION("RPTSALDOVACAC", "SALDO DE VACACIONES", 10000011L),
...
//    RPT_CONSOLIDADO_REGIONAL("RPTCONSREGIONAL", "RPT. CONSOLIDADO REGIONAL", 10010L),
    ...
    RPT_OPERATIVO_MINERIA_ILEGAL_COORDENADAS("RPTOPERMINILECOOR", "OPERATIVO DE MINERIA ILEGAL CON COORDENADAS", 10014L),
