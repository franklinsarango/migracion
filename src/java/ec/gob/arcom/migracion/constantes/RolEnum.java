...
public enum RolEnum 
{
    ...
    ROL_RECEPCIONISTA("RECEPCION","Recepcionista","INT",28L),
    ROL_SUBSECRETARIA_REGIONAL_MINAS("SUBSECREGION","Subsecretaria Regional de Minas","INT",9L),    
    ROL_SUBSECRETARIA_NACIONAL_CONTRATACION("SNACON","Subsecretaria Nacional de Contratacion","",27L),
    ...
    ROL_RECEPCIONISTA_SUBSECRETARIA_GENERAL("RCSBGN","Recepcionista Subsecretaría General","INT",16L),
